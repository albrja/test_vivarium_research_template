...
from test_vivarium_research_template.constants import data_keys, metadata
from test_vivarium_research_template.tools.app_logging import (
    add_logging_sink,
    decode_status,
)
from test_vivarium_research_template.utilities import sanitize_location
...
def build_single_location_artifact(
    ...
    from test_vivarium_research_template.data import builder
